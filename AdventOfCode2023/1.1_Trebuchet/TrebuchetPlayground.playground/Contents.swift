...
class Trebuchet {
    ...
    func sum(input: String) -> Int {
        ...
        for line in separatedLines {
            var newLine = line.filter({ $0.isNumber })
...
Trebuchet().sum(input: Trebuchet().inputShort) // Right Answer is 142
Trebuchet().sum(input: Trebuchet().inputLong) // Right Answer is 56397
